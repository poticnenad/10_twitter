...
Database.initialise(user='postgres', password='nn', database='postgres', host='localhost')
...
tweets = user.twitter_request(user.twitter_request('https://api.twitter.com/1.1/search/tweets.json?q=computers+filter:images'))
